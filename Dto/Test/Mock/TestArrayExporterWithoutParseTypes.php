...
class TestArrayExporterWithoutParseTypes extends Data\ImmutableData
{
    ...
    protected ?TestArrayExporterWithoutParseTypes $nestedObject;
    ...
    public function nestedObject() : ?TestArrayExporterWithoutParseTypes //If a class is extended, strong typing will cause errors in resolution
    {
